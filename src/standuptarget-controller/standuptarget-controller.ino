/*
  $Id: standuptarget-controller.ino 280 2023-11-16 15:13:00Z daisuke $
...
byte data[4] = {0x00, 'S', 'T', 'G'};

const int DEBOUNCE = 5; // チャタリング無視時間(ms)
...
const byte STARGET_HIT       = 0x01; // ヒット検知
